            ...
            {finishedMatches.map((match) => {
              ...
              return (
                <button
                  ...
                  className="w-full rounded-3xl border border-border bg-card p-5 text-left shadow-card transition hover:border-ring/30"
                >
                    ...
                    <div className="flex items-center gap-4 sm:flex-col sm:items-end">
                      ...
                      {match.predicted ? (
                        <div className="inline-flex items-center gap-1.5 rounded-xl border border-success/20 bg-success/10 px-4 py-2 text-sm font-semibold text-success">
                          <CheckCircle2 className="h-4 w-4" /> Predicted score{" "}
